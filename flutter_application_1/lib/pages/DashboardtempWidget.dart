...
class DashboardtempWidget extends StatefulWidget {
  ...
  @override
  State<DashboardtempWidget> createState() => _DashboardtempWidgetState();
}

class _DashboardtempWidgetState extends State<DashboardtempWidget>
    with TickerProviderStateMixin {
  late DashboardtempModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DashboardtempModel());
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0, 4, 0, 0),
                                      child: Text(
                                        'Plan , track and achieve debt-free',
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Plus Jakarta Sans',
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  'Current Debt Ratio Per current income',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelMedium
                                                      .override(
